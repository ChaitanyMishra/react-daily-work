    ...
    <div className='flex flex-col bg-zinc-400 h-screen w-screen rounded-2xl items-center justify-center '>
      <div className='flex flex-col gap-10'>
        <h1 className='text-5xl text-center'>Toggle input</h1>
            ...
            <button className='px-3 py-4 rounded-xl bg-slate-900 text-white' onClick={() => setButtonState(!buttonState)}>{buttonState ? "click me" : "reset text"} {buttonState.value}</button>
