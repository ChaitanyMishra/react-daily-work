...
const Card = () =>{
   return(
    ...
    <div className=" absolute flex flex-col h-[20rem] w-[14rem] bg-purple-600 m-auto my-14 rounded-2xl">
        ...
        <button className="bg-purple-950 text-blue-100 px-3 py-2 w-28 rounded-xl mx-auto my-3 hover:bg-purple-500 bg-transparent backdrop: hover:scale-105 duration-300 "> Submit </button>
