...
const Card = () =>{
   ...
   return(
    ...
    <div className=" absolute flex flex-col h-[20rem] w-[14rem] bg-purple-600 m-auto my-14 rounded-2xl">
        ...
        <input type="text" className=" bg-purple-400 px-3 py-3 rounded-xl w-[14vw] mx-auto text-purple-100" id="inputBox" onChange={(e) => setName(e.target.value)} value= />
