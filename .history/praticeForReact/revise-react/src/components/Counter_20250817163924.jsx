...
export default function Counter() {
  ...
  const [counter , addCounter] = useState
  
  return (
    <div className=' flex justify-center gap-5 text-white'>
      
      <button onClick={addCounter} className=' rounded-xl bg-blue-500 px-3 py-1 text-lg hover:bg-blue-600 hover:text-cyan-100 w-auto'>Increse</button>
