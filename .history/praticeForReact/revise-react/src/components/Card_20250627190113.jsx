...
const Card = () =>{
   ...
   return(
    ...
    <div className=" absolute flex flex-col h-[20rem] w-[14rem] bg-purple-600 m-auto my-14 rounded-2xl">
        <h3 className=" text-center text-purple-100 font-extrabold italic text-xl">Learn About Event Heandling</h3>
       ...
       {
        msg && (
            <p className="mt-4 text-white font-semibold text-center text-xl px-3 my-3">Hello {name}! nice to meet you!</p>
        )
       }
    </div>
    </div>
