...
export default function Counter() {
  ...
  return (
    <div className=" dark:bg flex flex-col items-center bg-slate-600 px-6 py-6 rounded-lg shadow-lg space-y-4">
      <div>
      <button className="bg-white hover:bg-blue-200 text-black font-bold px-4 py-2 rounded">{theme}</button>
      </div>
