...
function App() {
  ...
  <div className=' flex items-center justify-center mx-auto bg-purple-200 h-screen w-full rounded-lg '>
    ...
    <button className=' px-4 py-2 rounded-lg bg-slate-800 text-white w-24 relative left-64 top-14  '>Git Hub</button>
     <button className=' px-4 py-2 rounded-lg bg-blue-700 text-white w-24 relative left-12 top-14  '>LinkedIn</button>
