...
function App() {
  ...
  <div className=' flex items-center justify-center mx-auto bg-purple-200 h-screen w-full rounded-lg '>
    ...
    <h2 className=' text-white'>Click TO check Out</h2>
    <button className=' px-4 py-2 rounded-lg bg-slate-800 text-white w-24 relative left-64 top-24  '>Git Hub</button>
     <button className=' px-4 py-2 rounded-lg bg-blue-700 text-white w-24 relative left-12 top-24  '>LinkedIn</button>
