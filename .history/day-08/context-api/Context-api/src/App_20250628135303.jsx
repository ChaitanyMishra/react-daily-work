...
function App() {
  ...
  <div className=' flex items-center justify-center mx-auto bg-purple-200 h-screen w-full rounded-lg '>
    ...
    <h2 className=' text-white font-extrabold text-xl py-0 text-center bg-slate-600 w-auto'>follow me on Linkedin/Github</h2>
    <a className=' px-4 py-2 rounded-lg bg-slate-800 text-white w-24 relative left-64 top-20 hover:bg-slate-500  '
