...
function App() {
  ...
  <div className=' flex items-center justify-center mx-auto bg-purple-200 h-screen w-full rounded-lg'>
    ...
    <p className=''>I'm Chaitany Mishra, a BCA student passionate about Full Stack Web Development and Cloud Computing. I focus on building real-world projects while strengthening my core skills in JavaScript, React, and backend technologies.</p>
