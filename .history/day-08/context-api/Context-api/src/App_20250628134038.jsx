...
function App() {
  ...
  <div className=' flex items-center justify-center mx-auto bg-purple-200 h-screen w-full rounded-lg '>
    ...
    <h2 className=' text-white font-extrabold text-xl py-0'>Click TO check Outcd day-08/context-api/context-api</h2>
    <button className=' px-4 py-2 rounded-lg bg-slate-800 text-white w-24 relative left-64 top-20  '>Git Hub</button>
