...
function App() {
  ...
  <div className=' flex items-center justify-center mx-auto bg-purple-200 h-screen w-full rounded-lg '>
    <div className=' absolute h-screen max-h-[65vh] py-3 w-full max-w-[35vw] min-w-[25vw] bg-slate-950 rounded-lg hover:shadow-lg hover:shadow-purple-400 hover:scale-105 duration-500'>
    ...
    <h2 className=' text-white font-extrabold text-xl py-0 text-center'>follow me on Linkedin/Github</h2>
    <button className=' px-4 py-2 rounded-lg bg-slate-800 text-white w-24 relative left-64 top-20 hover:bg-slate-500  '>Git Hub</button>
     <button className=' px-4 py-2 rounded-lg bg-blue-700 text-white w-24 relative left-12 top-20 hover:bg-blue-500 '
