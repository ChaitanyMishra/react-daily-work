...
function App() {
  ...
  <div className=' flex items-center justify-center mx-auto bg-purple-200 h-screen w-full rounded-lg'>
    <div className='h-screen max-h-[65vh] py-3 w-full max-w-[25vw]  bg-purple-600 rounded-lg hover:shadow-lg hover:shadow-purple-400 hover:scale-105 duration-500'>
