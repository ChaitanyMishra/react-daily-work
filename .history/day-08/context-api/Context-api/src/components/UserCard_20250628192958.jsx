...
import './index.css';
import myIm from './Logo.jpg'
function UserCard() {
  return (
    <div className="flex items-center justify-center bg-purple-200 min-h-screen w-full px-4">
      <div className="relative w-full max-w-md bg-slate-950 rounded-lg p-5 hover:shadow-lg hover:shadow-purple-400 hover:scale-105 duration-500">
        <img
          src={myImg}
          alt="Chaitany"
