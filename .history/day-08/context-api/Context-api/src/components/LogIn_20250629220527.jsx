...
function LogIn() {
  ...
  return (
    <div className='bg-slate-50 flex flex-col mx-3 my-4 h-screen items-center justify-center text-white text-xl'>
      ...
      <form onSubmit={handleSubmit} className='flex flex-col mx-3 my-4 rounded-lg bg-slate-300  justify-around'>
        ...
        <p className='text-sm text-slate-600 px-5 pb-3 text-center'>Don't have account? <span className='italic text-blue-600'>sign up</span></p>
      </form>
    </div>
  )
}
