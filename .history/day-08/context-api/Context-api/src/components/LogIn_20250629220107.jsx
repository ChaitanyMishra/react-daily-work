...
function LogIn() {
  ...
  return (
    <div className='bg-slate-50 flex flex-col mx-3 my-4 h-screen items-center justify-center text-white text-xl'>
      ...
      <form onSubmit={handleSubmit} className='flex flex-col mx-3 my-4 rounded-lg bg-slate-300 max-h-auto'>
        <label className='text-slate-700 px-3 font-semibold text-base italic'>username:</label>
        <input
          type="text"
        ...
        />
         <label className='text-slate-700 px-3 font-semibold text-base italic'>password</label>
        <input
          type="password"
