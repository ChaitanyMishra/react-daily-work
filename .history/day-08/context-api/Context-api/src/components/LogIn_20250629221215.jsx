...
function LogIn() {
  ...
  return (
    <div className='bg-slate-50 flex flex-col mx-3 my-4 h-screen items-center justify-center text-white text-xl dark:bg-slate-900 dark:shadow-slate-300 dark'>
