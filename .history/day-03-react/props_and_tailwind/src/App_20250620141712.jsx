...
function App() {
  ...
  <h1 className='bg-red-100 text-purple-700 text-center p-3 rounded-xl hover:bg-red-200' >day-03-react</h1>
...
<Card className=' min-w-20' newDetails={myDetails}/>
<Card className='min'newDetails={myDetails2}/>
<Card className='min'newDetails={myDetails3}/>
<Card className='min'newDetails={myDetails}/>
<Card className='min'newDetails={myDetails}/>
</div>
