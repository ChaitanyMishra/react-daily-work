...
function ProfileCard({name , jobRole}){ 
    console.log(somObj.name)
    console.log(somObj.jobRole)
    return(
  ...
  <div className="space-y-2 text-center sm:text-left">
    <div className="space-y-0.5">
      <p className="text-lg font-semibold text-black">{somObj.name}</p>
      <p className="font-medium text-gray-500">{somObj.jobRole}</p>
    </div>
