...
export function VacationCard({ img, imgAlt, eyebrow, title, pricing, url }) {
  return (
    <div>
      <img className="rounded-lg" src="https://images.pexels.com/photos/2379004/pexels-photo-2379004.jpeg?_gl=1*il8jyg*_ga*MTQ1MTE1NTQ4Mi4xNzQwNzYxMTMw*_ga_8JE65Q40S6*czE3NTAzNTYzODIkbzMkZzEkdDE3NTAzNTY0OTMkajE0JGwwJGgw" alt={imgAlt} />
      <div className="mt-4">
