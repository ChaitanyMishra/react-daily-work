...
function App() {
  ...
  return (
    <div className='w-full h-screen bg-slate-900 rounded-3xl '>
    <h1 className=' mt-24 text-4xl font-serif font-bold text-blue-300 '>BackGround Color Changer Project</h1>
