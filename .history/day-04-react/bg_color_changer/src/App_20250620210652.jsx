...
function App() {
  ...
  return (
    <div className=' transition-all duration-500 w-full h-[45rem] rounded-3xl ' style={{backgroundColor: colorState}}>
...
export default App
https://prod.liveshare.vsengsaas.visualstudio.com/join?7CE678A6492E69C39D838DE6EFDF1E52CF74