// App.jsx (located in src/)
import { TodoProvider } from "./Context";               // ✅ Context folder is in same directory
import TodoForm from "./Components/TodoForm";           // ✅ Case-correct
import TodoItems from "/TodoItems";         // ✅ Case-correct
