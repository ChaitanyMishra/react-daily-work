...
return(
  ...
  <div>
    ...
    <ul className=" text-violet-200 flex gap-5 justify-center pt-4 items-center "><span className="text-2xl">Soft Skills: </span>
    ...
    <ul className=" text-violet-200 flex gap-5 justify-centerflex f pt-4 items-center "><span className="text-2xl">Tools: </span>
    <li>Stripe API</li>
    <li>Open API</li>
    <li>Socket.IO</li>
    <li>ESLint</li>
