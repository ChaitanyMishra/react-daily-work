...
function App() {
return(
  <div className=" bg-violet-300 h-screen w-screen ">
  <h1 className=" text-violet-300 text-center font-serif font-semibold text-2xl pb-12 ">Chaitany Mishra - Frontend Devloper</h1>
