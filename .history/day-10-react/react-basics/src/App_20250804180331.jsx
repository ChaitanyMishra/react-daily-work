...
return(
  ...
  <h1 className=" text-violet-300 text-center font-serif font-semibold text-2xl pt-5 ">Chaitany Mishra - Frontend Devloper</h1>
  ...
  <h2 className=" text-center text-violet-200 pt-16 text-3xl font-semibold italic">Skills</h2>
  <div>
    <h2 className="text-xl text-center mt-8 text-violet-200">Technical Skills:</h2>
    ...
    <h2 className="text-xl text-violet-200 text-center mt-3">Tools & Technology</h2>
    <ul className=" text-violet-200 flex gap-5 justify-center  pt-4 items-center ">
    <li>Stripe API</li>
    <li>Open API</li>
    <li>Socket.IO</li>
