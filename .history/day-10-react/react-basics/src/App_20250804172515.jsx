...
return(
  ...
  <div className=" flex gap-34 mt-5">
    <div className=" p-8">
    ...
    <div className=" w-80 h-80 overflow-hidden rounded-3xl sha" >
    <img src="chaitany.jpg" alt="Chaitany" srcset="" className=" h-full w-full object-cover  pr-28 pt-10 rounded-xl"  />
    </div>
  </div>
  </div>
