...
function App() {
  ...
  return (
    <div className=" flex flex-col justify-center w-full max-w-xl mx-auto my-5 shadow-2xl rounded-xl h-auto px-4 py-6 bg-slate-800 text-blue-200">
      <h1 className="text-blue-200 text-3xl font-bold">Password Generator</h1>

      {/* Password display + Copy */}
      <div className="flex my-4 mx-3 px-3 py-2 rounded-2xl overflow-hidden shadow-inner">
        <input
          type="text"
          value={password}
          readOnly
