    ...
    <>
      ...
      <div className=' w-full max-w-lg mx-auto my-5 shadow-2xl rounded-xl h-auto px-4 py-6 bg-slate-800 text-blue-200 '>
        ...
        <div className=' flex my-4 mx-2 px-3 py-2 rounded-2xl shadow-2xl overflow-hidden'>
           ...
           className=' text-gray-900 outline-none w-full py-2 px-3 rounded-l-xl readOnly '
        ...
        <div className='flex text-base gap-x-2'>
          <div className='flex items-center gap-x-1'>
            <input type="range" min={8} max={60} value={length} className=' cursor-pointer' onChange={(e) => setLength(e.target.value)} />
