...
function App() {
  ...
  return (
    <>
      ...
      <div className='flex justify-center items-center flex-col w-full max-w-md mx-auto my-5 shadow-2xl rounded-xl h-auto px-4 py-6 bg-slate-800 text-blue-200 '>
